...
def create_db():
            ...
            c.execute("""CREATE TABLE IF NOT EXISTS COUPONS(coupon_id integer primary key,coupon_code varchar ,discount integer)""")
            ...
            c.execute("""CREATE TABLE IF NOT EXISTS ORDERS(order_id integer primary key ,product_name varchar COLLATE NOCASE,amount integer,username varchar,purchase_date date)""")
            return conn
